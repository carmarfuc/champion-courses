                        ...
                        <div class="container overflow-hidden text-center">
                            <div class="row gy-5">
                                ...
                                @elseif (Auth::user()->role == 'TEACHER')
                                    ...
                                    <div class="col-6">
                                        <a href="/payments">
                                            <div class="p-3 text-start text-white rounded-3 bg-primary"><h3>👨🏼‍💻 <b>{{$currentStudents}}</b> Current Students</h3></div>
                                        </a>
                                    </div>
                                    <div class="col-6">
                                        <a href="/payments">
                                ...
                                @elseif (Auth::user()->role == 'STUDENT')
                                    ...
                                    <div class="col-6">
                                        <a href="/payments">
                                            <div class="p-3 text-start text-white rounded-3 bg-success"><h3>💰 <b>$ {{$totalDebt}}</b> Total Debt</h3></div>
                                        </a>
                                    </div>
                                @endif
                            </div>
